							...
							<div class="col-md-7 col-sm-7">
								<div class="row galery">
									<div class="inner">
										...
										<?if(($countAll)>1){?>
											<div class="flexslider unstyled row" id="slider" data-plugin-options='{"animation": "slide", "directionNav": true, "controlNav" :false, "animationLoop": true,"slideshow": true, "slideshowSpeed": 3000, "sync": ".detail .galery #carousel", "counts": [1, 1, 1]}'>
										<?}else{?>
