...
?>
<div class="catalog item-views table catalos_elements_block">
	<?if($arResult["ITEMS"]):?>
...
<?$frame->end();?>
<script>
	if ($(".catalos_sections_block").length>0){
		$(".catalos_sections_block .row.items").append($(".catalos_elements_block .row.items").html());
		$(".catalos_elements_block .row.items").html("");
	}
</script>